...
export function Navbar() {
  ...
  return (
    <div className="relative w-full bg-[#232222] h-16">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="absolute left-3 top-1 inline-flex items-center -space-x-4">
          <span>
            <Image
              src="/logo.png" // Replace with the path to your PNG image
              alt="Logo"
              width={80} // Adjust width as needed
              height={80}
              viewBox="0 0 50 56" // Adjust height as needed
            />
          </span>
          <span className="font-bold text-xl text-white">SHRUTI PATIL</span>
        </div>
        <div className="absolute top-5 right-60 hidden lg:block">
        ...
        <div className="absolute right-5 top-3 hidden lg:block">
          <button
            type="button"
